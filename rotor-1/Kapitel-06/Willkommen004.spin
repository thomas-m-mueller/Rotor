'Prototyp "Willkommen"-Programm, Version 0.4
CON
' Konstanten
  _xinfreq = 5_000_000
...
PUB Main
  ...
  term.Str (@Namen)        ' Ausgabe gespeicherten String
  Buchstaben := strsize(@Namen)    'Anzahl der Buchstaben
  term.NewLine
  term.Str (string("Dein Name hat "))
  term.Dec (Buchstaben)                  ' Ausgabe Anzahl  
